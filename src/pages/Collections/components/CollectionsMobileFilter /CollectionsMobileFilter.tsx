import styles from "./CollectionsMobileFilter.module.scss";
...
const CollectionsMobileFilter = ({showFilter}: Props) => {
  ...
  useEffect(() => {
    const limit = showAll && total ? total : SPECIALIZATIONS_LIMIT;
    getSpecializations(limit);
  }, [showAll]);

  return (
    <div className={styles.filter}>
      <button className={styles.closeButton} onClick={showFilter}>
...
export default CollectionsMobileFilter;
